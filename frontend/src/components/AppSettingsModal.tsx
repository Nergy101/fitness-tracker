...
/** One modal for everything configurable: appearance, sound, date format,
 *  and the health profile. Opened from the gear icon in the header. */
            ...
            <div className="flex gap-1.5">
              {LOCALE_OPTIONS.map((opt) => (
                <button
                  ...
                  className={SEGMENT + "tabular-nums " + (locale === opt.locale ? SEGMENT_ON : SEGMENT_OFF)}
                >
                  {opt.label}
                </button>
              ))}
